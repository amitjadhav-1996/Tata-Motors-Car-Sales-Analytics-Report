...
Dataset:
       The dataset is present in excel and contained inconsistencies such as missing values, duplicate records, inconsistent text formats, incorrect data types, and other data quality issues.
